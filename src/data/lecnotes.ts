...
//   blank : 개념 빈칸테스트 { q: '…약수가 {{1}}개…', a: 빈칸 정답[], hint? }
//           q의 {{1}} {{2}} 자리표시 개수 = a 길이. 암기카드(memo) 기반이라 내용은 검산된 것.
...
export type Blank = { q: string; a: string[]; hint?: string }
export type LecNote = { t: string; intro?: string; sec: NoteSec[]; memo: Memo[]; q: Quiz[]; blank?: Blank[] }
