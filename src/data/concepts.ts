...
export const CONCEPTS: Concept[] = [
  {
    id: 'c-prime', subId: 'u1m1s1', title: '소수와 합성수',
    lines: [
  ...
  {
    id: 'c-power', subId: 'u1m1s2', title: '거듭제곱',
    lines: [
  ...
  {
    id: 'c-factorize', subId: 'u1m2s1', title: '소인수분해',
    lines: [
  ...
  {
    id: 'c-divcount', subId: 'u1m2s2', title: '약수의 개수',
    lines: [
  ...
  {
    id: 'c-gcd', subId: 'u1m3s1', title: '최대공약수',
    lines: [
  ...
  {
    id: 'c-lcm', subId: 'u1m3s2', title: '최소공배수',
    lines: [
  ...
  {
    id: 'c-abs', subId: 'u2m1s2', title: '절댓값',
    lines: [
  ...
  {
    id: 'c-compare', subId: 'u2m1s3', title: '수의 대소 관계',
    lines: [
      '(음수) $<$ $0$ $<$ (양수).',
  ...
  {
    id: 'c-addsub', subId: 'u2m2s1', title: '유리수의 덧셈과 뺄셈',
    lines: [
  ...
  {
    id: 'c-muldiv', subId: 'u2m2s2', title: '유리수의 곱셈과 나눗셈',
    lines: [
  ...
  {
    id: 'c-eq', subId: 'u3m3s1', title: '일차방정식의 풀이',
    lines: [
  ...
  {
    id: 'c-direct', subId: 'u4m2s2', title: '정비례',
    lines: [
  ...
  {
    id: 'c-inverse', subId: 'u4m2s3', title: '반비례',
    lines: [
