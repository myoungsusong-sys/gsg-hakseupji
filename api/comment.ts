...
것들이다. 자료에 그 항목이 적혀 있지 않으면 절대 쓰지 마라. 짐작·추측·미화 모두 금지다.
 · 수업 태도·집중·질문·숙제 (자료에 **'오늘 수업 태도'** 줄이 없으면.
   ...
   · **정도를 키우지 마라.** '졸려 함' → "수업 내내 졸았다" ✕ · '질문이 많았음' → "쉬지 않고
     질문했다" ✕. '내내·계속·전혀·한 번도·시종일관' 같은 말은 자료에 없는 정도 표현이다.
     체크된 말 그대로의 무게로만 쓴다.
 ...
 · **선생님이 한 말·행동** — "따로 불러 지도했습니다", "챙겨 오라고 얘기해 두었습니다",
   "그림을 그려 설명했습니다"는 자료에 적혀 있지 않으면 전부 지어낸 것이다.
   앞으로 하겠다는 계획은 '다음 학습 계획'이 자료에 있을 때만 쓴다.
 · **그 단원이 처음인지·오랜만인지** — 진도 이력은 자료에 없다. '첫 진도', '새 단원 시작',
   '오랜만에', '드디어' 같은 말을 쓰지 마라.
